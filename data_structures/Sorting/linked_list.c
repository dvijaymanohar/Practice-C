...
int ll_insert_before(struct node *head, void *b4_data_ptr, void *new_data_ptr)
{
  ...
  while (bef2_node->next != NULL)
    if (*(int *)(bef2_node->next->data) != *(int *)b4_data_ptr)
    {
...
int ll_insert_after(struct node *head, void *aft_data_ptr, void *new_data_ptr)
{
  ...
  while (aft_node->next != NULL)
    if (*(int *)(aft_node->next->data) != *(int *)aft_data_ptr)
    {
...
void *ll_delete_after(struct node *head, void *aft_data_ptr)
{
  ...
  while (aft_node->next != NULL)
    if (*(int *)(aft_node->data) != *(int *)aft_data_ptr)
    {
      aft_node = aft_node->next;
    }
    else
...
void *ll_delete_element(struct node *head, void *data_ptr)
{
  ...
  while (dnode->next != NULL)
    if (*(int *)(dnode->next->data) != *(int *)data_ptr)
    {
      dnode = dnode->next;
    }
    else
